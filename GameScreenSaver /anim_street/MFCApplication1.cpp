...
BOOL CMFCApplication1App::InitInstance()
{
	...
	CAnimationWindowStreet dlg;
	m_pMainWnd = &dlg;
   //INT_PTR nResponse = dlg.CreateEx(WS_EX_CLIENTEDGE, 
   //   AfxRegisterWndClass(0), 
   //   "My MFC Animation Program", 
   //   /*WS_OVERLAPPEDWINDOW*/ WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU,
   //   CW_USEDEFAULT, CW_USEDEFAULT, 1024 /*width*/, 768 /*height*/, NULL, 0);
   INT_PTR nResponse = dlg.CreateEx(0,
      AfxRegisterWndClass(0),
      "My MFC Animation Program",
      /*WS_MAXIMIZE |*/ /*WS_OVERLAPPEDWINDOW*/ WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU,
      CW_USEDEFAULT, CW_USEDEFAULT, 1024 /*width*/, 768 /*height*/, NULL, 0);
